...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/11 16:35:31 by luxojr            #+#    #+#             */
/*   Updated: 2023/12/11 16:44:10 by luxojr           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_img_ints(t_xpm *xpm)
{
	...
	i = -1;
	nb_pixels = xpm->width * xpm->height;
	while (++i < nb_pixels)
	{
...
/*void	print_parsing_xpm(t_xpm *xpm, char *filename)
{
	...
	printf("caracline = %s\n", xpm->carac_line);
	printf("caracline_index = %d ; first_color_line_index = %d ;
	last_color_line_index = %d ; first_img_line_index = %d\n",
	xpm->carac_line_index, xpm->first_color_line_index,
	xpm->last_color_line_index, xpm->first_img_line_index);
	printf("nb_line = %d ; nb_colors = %d ; height = %d ;
